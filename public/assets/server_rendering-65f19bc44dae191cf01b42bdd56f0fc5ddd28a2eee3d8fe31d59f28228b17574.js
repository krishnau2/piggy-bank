...
var Transaction = (function (_React$Component) {
  ...
  _createClass(Transaction, [{
    ...
    key: "handleAllocationChange",
    value: function handleAllocationChange(key, val) {
      var goalAllocation = _extends({}, this.state.goalAllocation);
      goalAllocation[key] = val;
      this.setState({ goalAllocation: goalAllocation });
    }
  }, {
    key: "wishlist",
    value: function wishlist() {
      ...
      wishlistItemComponent = this.props.wishlist.map(function (item) {
        return React.createElement(WishlistItem, {
          key: item.id,
          item: item,
          value: _this.state.goalAllocation[item.id],
          handleAllocationChange: _this.handleAllocationChange });
      });
    ...
    value: function onFormSubmit(e) {
      e.preventDefault();
      $.post('/deposits', { deposits: this.state,
    ...
    key: "resetStateValue",
    value: function resetStateValue() {
      var _this2 = this;
      ...
      var goalAllocation = _extends({}, this.state.goalAllocation);
      Object.keys(goalAllocation).map(function (key) {
        return _this2.handleAllocationChange(key, "");
      });
    }
  }, {
    key: "render",
    value: function render() {
      return React.createElement(
        "div",
        null,
        React.createElement(Message, { display: this.state.messageDisplay }),
        React.createElement(
          "form",
          ...
          React.createElement(
            ...
            React.createElement(
              "p",
              null,
              "Amount you wish to keep in ",
              this.props.selectedBank.name
            ),
          ...
          React.createElement(
            ...
            React.createElement(
              "p",
              null,
              "Allocate this amount to your Goals/Wishlists below"
            ),
            React.createElement(
              "p",
              { className: "unallocated-msg" },
              "Unallocated amount: ",
              React.createElement(
                "span",
                { className: "unallocated-amount" },
                "10000"
              )
            )
          ),
          ...
          React.createElement(
            ...
            React.createElement("input", { type: "submit", className: "btn btn-outline-success btn-lg", value: "SAVE" })
          )
        )
      );
    }
...
var WishlistItem = (function (_React$Component) {
  _inherits(WishlistItem, _React$Component);

  function WishlistItem(props) {
    _classCallCheck(this, WishlistItem);

    _get(Object.getPrototypeOf(WishlistItem.prototype), "constructor", this).call(this, props);
    this.handleOnchange = this.handleOnchange.bind(this);
  }
  ...
  _createClass(WishlistItem, [{
    ...
    value: function render() {
      return React.createElement(
        "div",
        { className: "card wishlist-item", key: this.props.item.id },
        React.createElement(
          "div",
          { className: "card-body" },
          React.createElement(
            "div",
            { className: "card-title wishlist-item-title" },
            this.props.item.name
          ),
          React.createElement(
            "div",
            { className: "card-text wishlist-item-details" },
            React.createElement(
              "table",
              null,
              React.createElement(
